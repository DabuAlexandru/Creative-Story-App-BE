...
public class DiscussionThreadController extends ValidationHandler {
    ...
    public ResponseEntity<Page<DiscussionThreadResponseDto>> retrieveAllDiscussionThreadOfMainThreadPaginate(
    ...
    public ResponseEntity<List<DiscussionThreadResponseDto>> retrieveAllDiscussionThreadOfMainThread(@PathVariable Integer mainThreadId) {
    ...
    @PostMapping("/create")
    public ResponseEntity<DiscussionThreadResponseDto> createDiscussionThread(@Valid @RequestBody CreateDiscussionThreadRequestDto newDiscussionThread) {
        return ResponseEntity.ok().body(this.discussionThreadService.createNewDiscussionThread(newDiscussionThread));
    }

    @PutMapping("/update/{discussionThreadId}")
    public ResponseEntity<DiscussionThreadResponseDto> updateDiscussionThread(@PathVariable Integer discussionThreadId, @Valid @RequestBody UpdateDiscussionThreadRequestDto updatedDiscussionThread) {
        return ResponseEntity.ok().body(this.discussionThreadService.updateDiscussionThread(discussionThreadId, updatedDiscussionThread));
    }
}
